...
export const getSalesPipelines = async (
  query?: SalesPipelineGetQueryInterface,
): Promise<PaginatedInterface<SalesPipelineInterface>> => {
  const response = await axios.get('/api/sales-pipelines', {
    params: query,
